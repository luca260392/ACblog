    ...
    <header class="vh-70 position-relative">
        ...
        <div class="container h-75 d-flex align-items-center">
            <div class="text-center text-white mx-auto">
                <h3 class="display-4 mb-4 fw-bold">Modifica: {{$game->title}}</h3>
                        ...
                        <form method="POST" action="{{route('game.update', $game)}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="cover" class="form-label fw-bold text-secondary-custom">
                                    <i class="bi bi-file-image me-2"></i>Copertina attuale
                                </label>
                                <img src="{{Storage::url($game->cover)}}" alt="" class="img-fluid my-4">
                                <input type="file"
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-custom btn-lg px-5 fw-bold">
                                    <i class="bi bi-plus-circle me-2"></i>Modifica Gioco
                                </button>
                            </div>
                            <div class="d-flex justify-content-center">
                                <a href="{{route('game.index')}}" class="btn-consoleShow mt-4">Torna alla lista dei giochi</a>
                            </div>
                        </form>
                    </div>
                </div>
