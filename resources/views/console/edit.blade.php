        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="bg-dark-custom border-0 shadow-lg">
                    <div class= "p-4">
                        <form method="POST" action="{{route('console.update', $console)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                <label for="logo" class="form-label fw-bold text-secondary-custom">
                                    <i class="bi bi-file-image me-2"></i>Logo attuale
                                </label>
                                <img src="{{Storage::url($console->logo)}}" alt="" class="img-fluid my-4">
                                <input type="file"
                            ...
                            <div class="mb-4">
                                ...
                                id="description"
                                name="description"
                                rows="4">{{$console->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-custom btn-lg px-5 fw-bold">
                                    <i class="bi bi-plus-circle me-2"></i>Modifica console
                                </button>
                            </div>
                            <div class="d-flex justify-content-center">
                                <a href="{{route('console.index')}}" class="btn-consoleShow mt-4">Torna alla lista delle console</a>
                            </div>
                        </form>
                    </div>
                </div>
