    ...
    <header class="vh-70 position-relative">
        ...
        <div class="container h-75 d-flex align-items-center">
            <div class="text-center text-white mx-auto">
                <h3 class="display-4 mb-4 fw-bold">Lista delle console</h3>
            ...
            <div class="row">
                @if (count($consoles) > 0)
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-5">
                        <x-console :console=$console />
                    </div>
                    @endforeach
                @else
                    <div class="col-12 mb-5">
                        <h5 class="mb-3">Non sono ancora state inserite delle console</h5>
                        <a href="{{route('console.create')}}" class="btn-consoleShow">Aggiungi una console</a>
                    </div>
                @endif
            </div>
        </div>
